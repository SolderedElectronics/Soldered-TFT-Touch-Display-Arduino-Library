/***************************************************
  GraphicsTest example will show you how to draw shapes and text
  to the screen and measure the time to draw it. Open Serial Monitor
  at 115200 baud rate to see the results. 
